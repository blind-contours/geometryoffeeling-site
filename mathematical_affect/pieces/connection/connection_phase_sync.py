"""
Geometry of Feeling — Connection: Connection Phase Sync
...
def render():
    fig, ax = make_fig()
    n_osc = 20; np.random.seed(88)
    natural_freqs = 1.0 + 0.5*np.random.randn(n_osc)
    ...
    cols = [GOLD, SILVER, PALE_GOLD, PALE_SILVER, AMBER, SILVER,
            GOLD, PALE_SILVER, COPPER, SILVER, GOLD, PALE_GOLD,
            SILVER, AMBER, PALE_SILVER, GOLD, SILVER, COPPER,
            PALE_GOLD, SILVER]
    for i in range(n_osc):
        frac = i/(n_osc-1)
