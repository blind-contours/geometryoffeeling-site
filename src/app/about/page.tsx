        ...
        <div className="max-w-2xl">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-body text-secondary">
                ...
                time, but never reaching zero. The half-life equation describes
                this precisely. Growth branches fractally — each new level of
                complexity generated by the same recursive rule. Connection
                follows coupled oscillators — two systems influencing each
                other&apos;s rhythm without ever fully merging.
              </p>
              <p className="text-body text-secondary">
          ...
          <section className="mb-16">
            ...
            <div className="space-y-4">
              ...
              <p className="text-body text-secondary">
                <span className="text-primary">Mark Rothko&apos;s color fields</span>{" "}
