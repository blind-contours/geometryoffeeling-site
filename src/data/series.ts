...
export const series: Series[] = [
  // ── CONNECTION ──────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "connection-encounter", title: "Encounter", series: "connection", equation: "dz/dt = (μ+iω)z − (1+iβ)|z|²z + εz̄ + κ(z₂−z₁)", description: "Two Stuart-Landau oscillators tracing their own limit cycles — separate orbits, separate rhythms. But when they pass close enough, a brief impulse fires: each path kinks toward the other, then settles into a slightly different orbit than before. Built from the math of coupled oscillators with encounter-triggered perturbation. I kept thinking about locking eyes with a stranger on the subway. Neither of you stops. But for a half-second your trajectories bend toward each other, and afterward you're both orbiting slightly differently than you were before. That's what this is. The kink is the glance. The altered orbit is what it leaves behind.", emotionalNote: "A glance that bends both orbits", background: "#E8D8B8", imageUrl: "/prints/connection/connection_encounter.jpg", price: 45 },
    ],
  },
