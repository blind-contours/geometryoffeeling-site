...
export const series: Series[] = [
  ...
  // ── PEACE ───────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "peace-still-water", title: "Still Water", series: "peace", equation: "∇²φ = 0", description: "Every point in agreement with what surrounds it. No tension, no gradient, no part pulling away from any other — the mathematical definition of rest, and it looks like it feels. Built from Laplacian equilibrium, where every point is exactly the average of its neighbors.", emotionalNote: "Every point in agreement with what surrounds it", background: "#F0EDE8", imageUrl: "/prints/peace/peace_still_water.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── PRIDE ───────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "pride-road", title: "Road", series: "pride", equation: "y = y₀ + Σhᵢe^(−(t−cᵢ)²/2wᵢ²)", description: "Forty-four lines spanning the full bottom edge, converging toward a warm glow on the horizon. The road isn't smooth — irregular speed bumps rise and fall, bigger where you're standing, smaller in the distance, with a couple more waiting ahead. The path has been walked on. It has texture. That's what makes it real.", emotionalNote: "The path isn't smooth — that's what makes it real", background: "#f3eee7", imageUrl: "/prints/pride/pride_road.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
