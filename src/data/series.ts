...
export const series: Series[] = [
  ...
  // ── GRIEF ───────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "grief-void", title: "Void", series: "grief", equation: "(x−cx)²/a²+(y−cy)²/b²=1", description: "Lines flow around an empty elliptical center — crowding toward the absence but never entering. The void is the subject.", emotionalNote: "All lines converge on what is no longer there", background: "#DDD9D2", imageUrl: "/prints/grief/grief_void.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      ...
      { id: "grief-heat-diffusion", title: "Heat Diffusion", series: "grief", equation: "∂u/∂t=α·∂²u/∂x²", description: "A sharp initial pulse diffusing over time — the cathedral spire of presence that spreads to flatline.", emotionalNote: "The sharp edge of presence diffuses into nothing", background: "#DDD9D2", imageUrl: "/prints/grief/grief_heat_diffusion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      { id: "grief-drift", title: "Drift", series: "grief", equation: "dx=v·dt+σ·dW", description: "Particles scattering from a central point by Brownian motion — things that were together, drifting irrevocably apart.", emotionalNote: "Scattering from a center that can no longer hold", background: "#DDD9D2", imageUrl: "/prints/grief/grief_drift.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      { id: "grief-spectral-erosion", title: "Spectral Erosion", series: "grief", equation: "fₙ(t)=Σ(1/k)·sin(kωt+φₖ)", description: "A Fourier series progressively losing higher harmonics — rich texture collapsing to a bare fundamental tone.", emotionalNote: "Detail lost, only the root tone remains", background: "#DDD9D2", imageUrl: "/prints/grief/grief_spectral_erosion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
    ],
  ...
  // ── NOSTALGIA ───────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "nostalgia-remnant", title: "Remnant", series: "nostalgia", equation: "P(keep) = 1 − 0.95·t^{3/2}", description: "Waves dissolving into scattered points — the signal strong and continuous on the left, fragmenting into isolated dots as it moves right. Memory losing resolution.", emotionalNote: "The signal dissolving into scattered points", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_remnant.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      { id: "nostalgia-threshold", title: "Threshold", series: "nostalgia", equation: "A(x) = A₀·e^(−λ|x−x_b|)", description: "Where past meets present — vivid oscillations on the left flatten to ghost lines as they cross an invisible boundary. Tendrils of memory reaching into the present.", emotionalNote: "Where past meets present, tendrils crossing", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_threshold.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      { id: "nostalgia-fading-light", title: "Fading Light", series: "nostalgia", equation: "I(t) = I₀·e^(−t/τ)", description: "Horizontal bands of light dimming from left to right — sunset colors settling lower on the canvas, each line thinner and fainter than the last. The slow dimming of what was once bright.", emotionalNote: "The slow dimming of what was bright", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_fading_light.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
    ],
