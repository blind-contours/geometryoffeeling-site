...
export const series: Series[] = [
  ...
  // ── CONNECTION ──────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "connection-orbit-pair", title: "Orbit Pair", series: "connection", equation: "r(θ) = a(1−e²)/(1+e·cosθ)", description: "Two orbital paths locked in gravitational embrace — ellipses that share a focus, forever circling the same invisible center.", emotionalNote: "Two orbits sharing the same gravity", background: "#0A0A12", imageUrl: "/prints/connection/connection_orbit_pair.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      ...
      { id: "connection-entanglement", title: "Entanglement", series: "connection", equation: "|ψ⟩ = (|01⟩ - |10⟩)/√2", description: "Two quantum-correlated signals separated in space but mirroring each other's fluctuations. Visible connecting lines trace the invisible bond.", emotionalNote: "Correlated at any distance", background: "#0A0A12", imageUrl: "/prints/connection/connection_entanglement.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
      { id: "connection-torus-knot", title: "Torus Knot", series: "connection", equation: "x = (R+r·cos(qt))cos(pt)", description: "A curve that winds around a torus — two frequencies locked in a topological knot that can never be untied.", emotionalNote: "Two frequencies knotted together", background: "#0A0A12", imageUrl: "/prints/connection/connection_torus_knot.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 22 },
