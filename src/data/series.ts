...
export const series: Series[] = [
  ...
  // ── LONGING ─────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "longing-tantalus", title: "Tantalus", series: "longing", equation: "lim_{x→a} f(x) = L, f(a) undefined", description: "Longing is the shape of almost. The thing you reach for is vividly there — defined, imaginable, close enough to alter you — and still it refuses to become yours. That charged distance between promise and touch. Built from a limit that approaches meaning without ever resolving into contact.", emotionalNote: "You can see exactly where it should be but can't be there", background: "#E0E4E8", imageUrl: "/prints/longing/longing_tantalus.jpg", price: 45 },
