...
export const series: Series[] = [
  // ── FRACTURED ───────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "fractured-catastrophe-fold", title: "Catastrophe Fold", series: "fractured", equation: "V(x) = x⁴ + ax² + bx", description: "Built from Thom's catastrophe theory — a smooth surface that drops away without warning. I wanted to render the moment right before you realize the ground is gone.", emotionalNote: "The ground giving way under something that looked solid", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_catastrophe_fold.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── CYCLES ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "cycles-rosette", title: "Rosette", series: "cycles", equation: "r(θ) = a·cos(kθ)", description: "A rhodonea curve — one equation rotating through itself, tracing petals. Whether they close depends on whether k is rational. I liked the ones that almost close.", emotionalNote: "Petals that almost close but never quite do", background: "#F0E8DA", imageUrl: "/prints/cycles/cycles_rosette.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "cycles-orbit", title: "Orbit", series: "cycles", equation: "r(θ) = a(1−e²)/(1 + e·cos θ)", description: "Kepler's orbital equation — the ellipse every planet traces. Always coming back, never quite arriving. The orbit is the point, not the destination.", emotionalNote: "Always coming back, never arriving", background: "#F0E8DA", imageUrl: "/prints/cycles/cycles_orbit.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "cycles-recurrence", title: "Recurrence", series: "cycles", equation: "R(i,j) = Θ(ε − ‖xᵢ − xⱼ‖)", description: "A recurrence plot — I marked every moment the system returns close to a previous state. Dark bands appear where you don't expect them, revealing hidden periodicity.", emotionalNote: "Moments the past returns close enough to recognize", background: "#F0E8DA", imageUrl: "/prints/cycles/cycles_recurrence.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── PRIDE ───────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "pride-crown", title: "Crown", series: "pride", equation: "r(θ) = 1 + ε·cos(nθ), n ≥ 5", description: "A circle perturbed with high-frequency peaks. The crown shape comes from small deviations from perfection — not random, but earned by the math.", emotionalNote: "Peaks earned by the math", background: "#F0EDE6", imageUrl: "/prints/pride/pride_crown.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "pride-flourish", title: "Flourish", series: "pride", equation: "γ(t) = (t·cos(t), t·sin(t), t²)", description: "A 3D spiral expanding upward and outward. Each revolution wider and higher than the last. I didn't constrain it — just let it grow.", emotionalNote: "Each turn wider and higher than the last", background: "#F0EDE6", imageUrl: "/prints/pride/pride_flourish.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "pride-golden-ratio", title: "Golden Ratio", series: "pride", equation: "φ = (1 + √5)/2 ≈ 1.618...", description: "The golden ratio as geometric proportion. 1.618... — the division that your eye recognizes as right before your brain can explain why.", emotionalNote: "The proportion you recognize before you understand it", background: "#F0EDE6", imageUrl: "/prints/pride/pride_golden_ratio.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "pride-spire", title: "Spire", series: "pride", equation: "h(x) = H · (1 - |x/w|^p)^{1/p}", description: "A superelliptic spire rising to a computed vertex. The math determines exactly where the peak goes — I just let the structure find its own height.", emotionalNote: "Height determined by structure, not force", background: "#F0EDE6", imageUrl: "/prints/pride/pride_spire.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "pride-unfurl", title: "Unfurl", series: "pride", equation: "θ(t) = θ₀ + (π - θ₀)(1 - e^{-t/τ})", description: "An angle opening from folded to fully extended — exponential approach to full openness. Something that was contained, choosing to unfurl.", emotionalNote: "Something contained, choosing to open", background: "#F0EDE6", imageUrl: "/prints/pride/pride_unfurl.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
