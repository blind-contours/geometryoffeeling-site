...
export const series: Series[] = [
  ...
  // ── GROWTH ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "growth-phyllotaxis", title: "Phyllotaxis", series: "growth", equation: "r = c√n, θ = n × 137.508°", description: "Two sunflowers — one full and heavy, one barely started — leaning toward each other on curved stems. Same rule driving both: each seed placed at the golden angle, spiraling outward. Nine hundred seeds packed tight in the parent bloom. A hundred and eighty in the young one, still finding its shape. Same mathematics, just earlier in the story.", emotionalNote: "Same rule, different scale — parent and child", background: "#F5F0E6", imageUrl: "/prints/growth/growth_phyllotaxis.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── PEACE ───────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "peace-convergence", title: "Convergence", series: "peace", equation: "zₙ₊₁ = zₙ − (zₙ⁵−1)/(5zₙ⁴)", description: "Every point in the complex plane has a destination, and that destination is rest. Five basins, five roots, five-fold symmetry — the boundaries between them are where the journey is most uncertain, but every path still arrives. The warm glow at the center is where all five petals meet. All conflict resolves.", emotionalNote: "Every path still arrives", background: "#F0EDE8", imageUrl: "/prints/peace/peace_convergence.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "peace-sand", title: "Sand", series: "peace", equation: "∂h/∂t = -∇·(h·v) + D∇²h", description: "The shape the wind decided on. Parallel ridges self-organized by patient, persistent force — not designed, not random, but emergent. The surface found its own form and keeps it.", emotionalNote: "The shape the wind decided on", background: "#F0EDE8", imageUrl: "/prints/peace/peace_sand.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
