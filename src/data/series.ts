...
export const series: Series[] = [
  // ── FRACTURED ───────────────────────────────────────────
  {
    ...
    description: "Five pieces exploring different geometries of breaking — the threshold where order dissolves, the patience of erosion, the path a crack follows through weakness, the silence before a rupture, the way shattered space divides by proximity. Each piece is built from the mathematics of how things actually come apart.",
    ...
    pieces: [
      { id: "fractured-bifurcation", title: "Bifurcation", series: "fractured", equation: "x_{n+1} = rx_n(1 - x_n)", description: "One road becomes two. Then four. Then the path dissolves into something no map can follow. I kept staring at that threshold — the last moment before complexity takes over, when a single choice still holds everything together. The logistic map does this with one parameter. Life does it with one decision.", emotionalNote: "That moment when one path becomes two and there's no going back", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_bifurcation.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "fractured-erosion", title: "Erosion", series: "fractured", equation: "∂z/∂t = D·∇²z", description: "Time does not break stone. It reshapes it — slowly, patiently, without force. I rendered the same cliff face twenty-eight times, each one softer than the last, sharp edges rounding into curves over geological time. The patience of water against stone.", emotionalNote: "The patience of water against stone", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_erosion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "fractured-glass-fracture", title: "Glass Fracture", series: "fractured", equation: "K_I = σ√(πa)", description: "A break doesn't happen at random. It follows every weakness that was already there — the invisible fault lines, the places where structure was thinnest. I kept looking at the pattern and realized: cracks don't choose where to go. The material already decided that long before the impact.", emotionalNote: "Every crack follows where the structure was already weakest", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_glass_fracture.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "fractured-seismic-fault", title: "Seismic Fault", series: "fractured", equation: "log₁₀(N) = a - bM", description: "The silence before the break is part of the break. Tension accumulates along an invisible line — nothing moves, nothing shows — and then everything releases at once. I wanted to hold both: the long quiet and the sudden rupture. Built from the Gutenberg-Richter law, which describes how energy builds in stillness before transforming into motion.", emotionalNote: "The silence before the break is part of the break", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_seismic_fault.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "fractured-voronoi-shatter", title: "Voronoi Shatter", series: "fractured", equation: "V(p) = {x : d(x,p) ≤ d(x,q) ∀q}", description: "When something shatters, each fragment claims the space closest to its center. The geometry of breaking is the geometry of belonging — every piece defined by what it was nearest to. Built from Voronoi tessellation, the same mathematics that governs how glass actually fractures.", emotionalNote: "Space divided by proximity — the geometry of things coming apart", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_voronoi_shatter.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── TENSION ─────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "tension-interference", title: "Interference", series: "tension", equation: "A(x) = A₁sin(k₁x) + A₂sin(k₂x)", description: "Two feelings occupying the same moment. Where they align, the intensity doubles — joy and relief stacking into something overwhelming. Where they oppose, nothing. Complete cancellation. There's no blending, no compromise. You feel everything or you feel nothing.", emotionalNote: "Where two forces meet, they double or they cancel", background: "#1A1A1A", imageUrl: "/prints/tension/tension_interference.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "tension-opposition", title: "Opposition", series: "tension", equation: "F_net = F₁ - F₂ = 0, |F₁| > 0", description: "Nothing moves. Everything strains. Two equal forces pressing from opposite directions hold each other in perfect stillness — but the stillness is not peace. It is maximum contained force, balanced on an edge. Built from static equilibrium, where the net force is zero but the internal stress is immense.", emotionalNote: "Perfect balance isn't peace — it's maximum contained force", background: "#1A1A1A", imageUrl: "/prints/tension/tension_opposition.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── GROWTH ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "growth-strata", title: "Strata", series: "growth", equation: "h(n) = 0.1 + H·(n/N)^1.3, color(n) = palette[(n/N)^0.65]", description: "Thirty-five arcs radiating from a molten core — yellow heat at the center pushing outward through amber, bronze, olive, into green and teal. Like looking at a cross-section of the earth, watching what's buried force its way toward the surface. The ripples aren't symmetric: the left side breaks in slow, deep waves while the right fractures into something more urgent. Growth isn't uniform. It pushes harder where there's less resistance.", emotionalNote: "The molten core pushing through earth toward light", background: "#F5F0E6", imageUrl: "/prints/growth/growth_strata.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "growth-unfurl", title: "Unfurl", series: "growth", equation: "r(n) = r₀·(n/N)^1.5, θ ∈ [−a(n)π, a(n)π]", description: "Thirty arcs opening from a single compressed point. The inner ones are so tight they nearly merge — a held breath, a closed fist. Then the outer arcs widen, thin, brighten toward gold, extend past the edges of the frame. I kept thinking about what it feels like when something that was clenched finally lets go. Power-law expansion: each arc claims exponentially more space than the last.", emotionalNote: "The moment a closed fist opens", background: "#F5F0E6", imageUrl: "/prints/growth/growth_unfurl.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "growth-crescendo", title: "Crescendo", series: "growth", equation: "y(n) = y₀ + 7.2·(n/N)², A(n) = 0.003 + 0.60·(n/N)³", description: "Eighteen horizontal lines, nearly silent at the bottom — flat, ghostly, barely there. Then the amplitude builds. By the top, the waves are bold, golden, undulating. The whole composition is mostly empty space, which is the point: growth needs room. Built from cubic amplitude growth with an asymmetric envelope — the wave swells rightward, like a voice finding its register.", emotionalNote: "From whisper to resonance", background: "#F5F0E6", imageUrl: "/prints/growth/growth_crescendo.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── CYCLES ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "cycles-loom", title: "Loom", series: "cycles", equation: "x(t) = x(t + T), T = 2π/ω", description: "I wanted to show what repetition builds. Threads crossing at exact intervals, each one predictable alone, but the fabric they make is something neither could be. That's what cycles do if you stay with them long enough — the routine becomes the structure you live inside.", emotionalNote: "Rhythm weaving itself into something solid", background: "#F0E8DA", imageUrl: "/prints/cycles/cycles_loom.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "cycles-breathing", title: "Breathing", series: "cycles", equation: "r(t) = r₀ + A·sin(ωt + φ)", description: "Expand. Contract. Repeat. The simplest cycle there is — lungs filling and emptying, the body's most fundamental rhythm reduced to concentric circles. Nothing needs to be added.", emotionalNote: "Expand, contract, repeat", background: "#F0E8DA", imageUrl: "/prints/cycles/cycles_breathing.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "cycles-tidal", title: "Tidal", series: "cycles", equation: "h(t) = Σ Aₙcos(ωₙt + φₙ)", description: "The ocean responding to something it can't see. Lunar and solar gravity pulling from different distances, their rhythms superimposed into the rise and fall of water — a cycle governed by forces far away and utterly silent. The ocean doesn't know why it moves. It just does.", emotionalNote: "The ocean responding to something it can't see", background: "#F0E8DA", imageUrl: "/prints/cycles/cycles_tidal.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── NOSTALGIA ───────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "nostalgia-reaching", title: "Reaching", series: "nostalgia", equation: "y(t) → ∞, ∂y/∂t → 0", description: "Moving forward but always reaching backward. A bold stem rising from an amber origin, thinning as it climbs, tendrils arcing off and sweeping back toward where it started. I couldn't make it stop reaching back.", emotionalNote: "Moving forward but always reaching backward", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_reaching.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "nostalgia-heirloom", title: "Heirloom", series: "nostalgia", equation: "Sₙ = (1+εₙ)·λ·Sₙ₋₁", description: "What is handed down is never perfectly preserved. It changes in the carrying — slightly altered, slightly marked, made more intimate by use. Each form a little less precise than the last, a little more itself.", emotionalNote: "Each copy a little less precise than the last", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_heirloom.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── DESIRE ──────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "desire-pursuit", title: "Pursuit", series: "desire", equation: "dx/dt=αx−βxy, dy/dt=δxy−γy", description: "I tried to make them meet. They won't — they circle each other endlessly, always closing the distance, never arriving. The system doesn't allow it. The approach is the point, not the arrival. That ache of almost-touching is where desire actually lives.", emotionalNote: "Endless approach, never arrival", background: "#E8D8D0", imageUrl: "/prints/desire/desire_pursuit.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "desire-magnetism", title: "Magnetism", series: "desire", equation: "B=μ₀/(4π)·(3(m·r̂)r̂−m)/r³", description: "The pull you can feel but can't see. Invisible force arcing between two bodies, shaping the space around them, bending every nearby path. You know it's there because everything curves. I wanted to render that — the thing that isn't visible but reshapes everything around it.", emotionalNote: "The pull you can feel but can't see", background: "#E8D8D0", imageUrl: "/prints/desire/desire_magnetism.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "desire-pulse", title: "Pulse", series: "desire", equation: "f(t)=A·exp(−(t mod T)/σ)", description: "A heartbeat that won't slow down. Peaked waveforms accelerating — spacing tightening, amplitude rising, each beat arriving sooner and harder than the last. The rhythm of wanting something more with every passing moment.", emotionalNote: "A heartbeat that won't slow down", background: "#E8D8D0", imageUrl: "/prints/desire/desire_pulse.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "desire-inspiral", title: "Inspiral", series: "desire", equation: "r(θ)=r₀·e^(−γθ)", description: "Accelerating toward something you can't stop. Concentric spirals tightening toward a glowing center, each orbit faster and closer than the last. I kept watching the curves accelerate inward and thought — that's what it feels like. The closer you get, the less choice you have.", emotionalNote: "Accelerating toward something you can't stop", background: "#E8D8D0", imageUrl: "/prints/desire/desire_inspiral.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── WONDER ──────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "wonder-primordial-pool", title: "Primordial Pool", series: "wonder", equation: "f(x,y,r,d) → Σ f(xᵢ,yᵢ,rᵢ,d−1)", description: "Circles within circles, particles drifting inside each one. I was trying to model recursion and what came out looked like life beginning — clusters forming in still water, each pool containing smaller pools, each one teeming with something almost alive. The green tint where density builds wasn't planned. It just emerged where enough particles overlapped, like the algorithm was discovering biology on its own.", emotionalNote: "Life assembling itself in still water", background: "#DDD9D2", imageUrl: "/prints/wonder/wonder_primordial_pool.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "wonder-recursion", title: "Recursion", series: "wonder", equation: "f(n) = f(f(n-1))", description: "The mountains in the distance carry the same structure as the ones up close. Each ridgeline built by subdividing, displacing, subdividing again — the horizon repeating the foreground, smaller and fainter but identical in its roughness. I kept zooming in and there was always more. That's what stopped me.", emotionalNote: "The same pattern, all the way back", background: "#DDD9D2", imageUrl: "/prints/wonder/wonder_recursion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── AWE ─────────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "awe-overview", title: "Overview", series: "awe", equation: "h/R ≈ 0.01‰", description: "Everything is under that thin line. Earth's atmosphere as a luminous arc against the void — drawn to scale. The line is impossibly thin. Everything anyone has ever known, felt, built, or loved exists beneath it.", emotionalNote: "Everything is under that thin line", background: "#0A0A10", imageUrl: "/prints/awe/awe_overview.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── RESILIENCE ──────────────────────────────────────────
  {
    ...
    description: "Strain hardening, post-traumatic growth, overshoot recovery, and delayed repair. Systems that return — often stronger — after being pushed past their limits.",
    ...
    pieces: [
      ...
      { id: "resilience-growth", title: "Growth", series: "resilience", equation: "dN/dt = r(K' - N), K' > K", description: "A single trajectory that drops, levels out, and then climbs — past where it began. Not back to normal. Past it. The line crosses above its original baseline and keeps going. I wanted to show that moment where you realize you're not just recovering. You're somewhere you couldn't have reached without the fall.", emotionalNote: "Growing back past where you started", background: "#E8E0D8", imageUrl: "/prints/resilience/resilience_growth.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "resilience-repair", title: "Repair", series: "resilience", equation: "G(t) = G₀(1 - e^{-t/τ_r}) · H(t-t_d)", description: "The pause before the repair begins. Nothing happens right after the damage — there's a flat silence, a gap where the function just stays at zero. Then the recovery starts, slowly. I kept the delay because that's how it actually works. The body waits before it heals.", emotionalNote: "The pause before the repair begins", background: "#E8E0D8", imageUrl: "/prints/resilience/resilience_repair.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── PRIDE ───────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "pride-road", title: "Road", series: "pride", equation: "y = y₀ + Σhᵢe^(−(t−cᵢ)²/2wᵢ²)", description: "Every day the path for the LGBTQ+ community is bumpy. The road smooths out when community comes together and supports each other — but then the world gets in the way. It always does. Here is that, rendered. No more description needed. You see it. You feel it.", emotionalNote: "The path isn't smooth — that's what makes it real", background: "#f3eee7", imageUrl: "/prints/pride/pride_road.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── LONGING ─────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "longing-tantalus", title: "Tantalus", series: "longing", equation: "lim_{x→a} f(x) = L, f(a) undefined", description: "Longing is the shape of almost. The thing you reach for is vividly there — defined, imaginable, close enough to alter you — and still it refuses to become yours. That charged distance between promise and touch. Built from a limit that approaches meaning without ever resolving into contact.", emotionalNote: "You can see exactly where it should be but can't be there", background: "#E0E4E8", imageUrl: "/prints/longing/longing_tantalus.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "longing-vanishing", title: "Vanishing", series: "longing", equation: "x' = x·f/(f+d), y' = y·f/(f+d)", description: "Always visible. Always the same distance away. Parallel lines converging to a point that recedes as you approach — the destination that stays on the horizon no matter how far you walk. I kept rendering it hoping the lines would meet. They won't.", emotionalNote: "Always visible, always the same distance away", background: "#E0E4E8", imageUrl: "/prints/longing/longing_vanishing.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
