...
export const series: Series[] = [
  // ── FRACTURED ───────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "fractured-bifurcation", title: "Bifurcation", series: "fractured", equation: "x_{n+1} = rx_n(1 - x_n)", description: "The logistic map's period-doubling cascade — a single path splitting into two, then four, then chaos.", emotionalNote: "The point where a single path becomes irreconcilable futures", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_bifurcation.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "fractured-glass-fracture", title: "Glass Fracture", series: "fractured", equation: "K_I = σ√(πa)", description: "Stress intensity at a crack tip — the mathematics of fracture mechanics. Each line propagates according to the Griffith criterion.", emotionalNote: "Every crack follows the path of least resistance through the structure", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_glass_fracture.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "fractured-seismic-fault", title: "Seismic Fault", series: "fractured", equation: "log₁₀(N) = a - bM", description: "The Gutenberg-Richter law — tension accumulates in silence, then releases all at once along the fault.", emotionalNote: "Tension that accumulates invisibly until the ground itself gives way", background: "#F5F0E0", imageUrl: "/prints/fractured/fractured_seismic_fault.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── CONNECTION ──────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "connection-pendulum", title: "Pendulum", series: "connection", equation: "θ̈ = -(g/L)sinθ + k(θ₂ - θ₁)", description: "Coupled pendulums in phase space — energy flowing back and forth between two systems, their trajectories spiraling around each other.", emotionalNote: "Energy flowing back and forth between two", background: "#0A0A12", imageUrl: "/prints/connection/connection_pendulum.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-orbit-pair", title: "Orbit Pair", series: "connection", equation: "r(θ) = a(1−e²)/(1+e·cosθ)", description: "Two orbital paths locked in gravitational embrace — ellipses that share a focus, forever circling the same invisible center.", emotionalNote: "Two orbits sharing the same gravity", background: "#0A0A12", imageUrl: "/prints/connection/connection_orbit_pair.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-magnetic", title: "Magnetic", series: "connection", equation: "B = B₁ + B₂, ∇×B = μ₀J", description: "Two magnetic dipoles with field lines arcing between them — above and below, the invisible force that pulls two poles together.", emotionalNote: "Field lines connecting two poles", background: "#0A0A12", imageUrl: "/prints/connection/connection_magnetic.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-lissajous", title: "Lissajous", series: "connection", equation: "x = sin(3t), y = sin(2t + φ)", description: "The classic Lissajous figure — two harmonics creating a figure that traces the same dance, half a beat apart.", emotionalNote: "The same dance, half a beat apart", background: "#0A0A12", imageUrl: "/prints/connection/connection_lissajous.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-entanglement", title: "Entanglement", series: "connection", equation: "|ψ⟩ = (|01⟩ - |10⟩)/√2", description: "Two quantum-correlated signals separated in space but mirroring each other's fluctuations. Visible connecting lines trace the invisible bond.", emotionalNote: "Correlated at any distance", background: "#0A0A12", imageUrl: "/prints/connection/connection_entanglement.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-torus-knot", title: "Torus Knot", series: "connection", equation: "x = (R+r·cos(qt))cos(pt)", description: "A curve that winds around a torus — two frequencies locked in a topological knot that can never be untied.", emotionalNote: "Two frequencies knotted together", background: "#0A0A12", imageUrl: "/prints/connection/connection_torus_knot.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-weave", title: "Weave", series: "connection", equation: "y₁ = sin(ωt), y₂ = sin(ωt + π/2)", description: "Pairs of sine waves interleaving at every frequency — from high-frequency tight braids to slow, sweeping crossings.", emotionalNote: "Pairs interleaving at every frequency", background: "#0A0A12", imageUrl: "/prints/connection/connection_weave.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-helix", title: "Helix", series: "connection", equation: "x = r·cos(t), y = r·sin(t), z = ct", description: "A double helix — two strands spiraling in parallel, always the same distance apart, never touching.", emotionalNote: "Parallel spirals, always the same distance apart", background: "#0A0A12", imageUrl: "/prints/connection/connection_helix.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-phase-sync", title: "Phase Sync", series: "connection", equation: "dθ/dt = ω + (K/N)Σsin(θⱼ−θᵢ)", description: "Kuramoto oscillators — scattered rhythms that gradually lock into the same beat. Chaos on the left, coherence on the right.", emotionalNote: "Scattered rhythms finding the same beat", background: "#0A0A12", imageUrl: "/prints/connection/connection_phase_sync.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-rossler", title: "Rössler", series: "connection", equation: "ẋ = −y−z, ẏ = x+ay", description: "Two Rössler attractors coupled in phase space — chaotic trajectories that shadow each other through folded space.", emotionalNote: "Chaos that follows chaos", background: "#0A0A12", imageUrl: "/prints/connection/connection_rossler.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-braid", title: "Braid", series: "connection", equation: "σ₁σ₂σ₁ = σ₂σ₁σ₂", description: "Three strands crossing and recrossing in a mathematical braid — topologically distinct from a simple twist.", emotionalNote: "Strands that cross and recross, never the same", background: "#0A0A12", imageUrl: "/prints/connection/connection_braid.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── TENSION ─────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "tension-interference", title: "Interference", series: "tension", equation: "A(x) = A₁sin(k₁x) + A₂sin(k₂x)", description: "Two wave sources creating an interference pattern — peaks where the waves align, silence where they cancel.", emotionalNote: "Where two forces meet, they either amplify or annihilate", background: "#1A1A1A", imageUrl: "/prints/tension/tension_interference.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "tension-opposition", title: "Opposition", series: "tension", equation: "F_net = F₁ - F₂ = 0, |F₁| > 0", description: "Equal and opposite forces in perfect balance — the net force is zero, but the internal stress is immense.", emotionalNote: "Perfect balance is not peace — it is maximum contained force", background: "#1A1A1A", imageUrl: "/prints/tension/tension_opposition.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── OVERWHELM ───────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "overwhelm-kuramoto", title: "Kuramoto", series: "overwhelm", equation: "dθᵢ/dt = ωᵢ + (K/N)Σsin(θⱼ - θᵢ)", description: "The Kuramoto model with dozens of oscillators — each trying to synchronize, none fully succeeding.", emotionalNote: "Dozens of rhythms trying and failing to align", background: "#0A0A12", imageUrl: "/prints/overwhelm/overwhelm_kuramoto.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "overwhelm-levy-swarm", title: "Levy Swarm", series: "overwhelm", equation: "P(x) ~ |x|^{-1-α}, 0 < α < 2", description: "A swarm of Lévy flights — heavy-tailed random walks with occasional enormous jumps.", emotionalNote: "Random motion that refuses to stay bounded", background: "#0A0A12", imageUrl: "/prints/overwhelm/overwhelm_levy_swarm.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "overwhelm-phase-flood", title: "Phase Flood", series: "overwhelm", equation: "ψ(x,t) = Σ Aₙ e^{i(kₙx - ωₙt + φₙ)}", description: "Dozens of complex wave functions superposed — the resulting field is everywhere nonzero and nowhere still.", emotionalNote: "Every point in space vibrating from every direction at once", background: "#0A0A12", imageUrl: "/prints/overwhelm/overwhelm_phase_flood.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "overwhelm-turbulence", title: "Turbulence", series: "overwhelm", equation: "Re = ρvL/μ >> Re_cr", description: "Fluid flow past the critical Reynolds number — order becomes chaos through a cascade of instabilities.", emotionalNote: "Order dissolving into chaos at every scale simultaneously", background: "#0A0A12", imageUrl: "/prints/overwhelm/overwhelm_turbulence.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── GRIEF ───────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "grief-heaviside-cascade", title: "Heaviside Cascade", series: "grief", equation: "H(t−tₙ) = {0, t<tₙ; 1, t≥tₙ}", description: "Stacked Heaviside step functions — each drop a sudden, irreversible loss. The staircase only descends.", emotionalNote: "Each step down is permanent", background: "#DDD9D2", imageUrl: "/prints/grief/grief_heaviside_cascade.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "grief-absence", title: "Absence", series: "grief", equation: "f(x) = Σ aₙ·e^(−λₙt)·cos(nπx)", description: "Fourier modes decaying at different rates — the complex shape of presence dissolving into silence, harmonic by harmonic.", emotionalNote: "What remains when all the frequencies fade", background: "#DDD9D2", imageUrl: "/prints/grief/grief_absence.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "grief-heat-diffusion", title: "Heat Diffusion", series: "grief", equation: "∂u/∂t = α·∂²u/∂x²", description: "Multiple heat sources diffusing over time — sharp spires of presence that spread and flatten into nothing.", emotionalNote: "The sharp edge of presence diffuses into nothing", background: "#DDD9D2", imageUrl: "/prints/grief/grief_heat_diffusion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── CONFUSION ───────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "confusion-aliased", title: "Aliased", series: "confusion", equation: "f_alias = |f - n·f_s|, n = round(f/f_s)", description: "A signal sampled below the Nyquist rate — the true frequency becomes indistinguishable from its aliases.", emotionalNote: "When the truth and its reflections become indistinguishable", background: "#E6E2DC", imageUrl: "/prints/confusion/confusion_aliased.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "confusion-knot", title: "Knot", series: "confusion", equation: "K: S¹ → S³", description: "A topological knot — a closed curve in three-dimensional space that cannot be untangled without cutting.", emotionalNote: "A path that crosses itself until the beginning is lost", background: "#E6E2DC", imageUrl: "/prints/confusion/confusion_knot.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "confusion-labyrinth", title: "Labyrinth", series: "confusion", equation: "maze(x,y) = {0,1} | ∃! path(start, end)", description: "A generated labyrinth with exactly one solution — the path exists, but finding it requires exhaustive search.", emotionalNote: "The solution exists but cannot be seen from inside", background: "#E6E2DC", imageUrl: "/prints/confusion/confusion_labyrinth.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "confusion-tangle", title: "Tangle", series: "confusion", equation: "γ(t): [0,1] → R³, self-intersecting", description: "Multiple space curves that intersect and interleave — each individually traceable, together inseparable.", emotionalNote: "Individually clear, collectively inseparable", background: "#E6E2DC", imageUrl: "/prints/confusion/confusion_tangle.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "confusion-vertigo", title: "Vertigo", series: "confusion", equation: "r(t) = e^{-at}(cos ωt, sin ωt, t)", description: "A spiral that simultaneously ascends and decays — the visual field tilts until orientation is lost.", emotionalNote: "The spiral that makes the ground uncertain", background: "#E6E2DC", imageUrl: "/prints/confusion/confusion_vertigo.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── SHAME ───────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "shame-contraction", title: "Contraction", series: "shame", equation: "T(x) : ||T(x)-T(y)|| < ||x-y||", description: "A contraction mapping — every iteration brings all points closer together. The fixed point is inevitable.", emotionalNote: "Collapsing toward a point that cannot be avoided", background: "#E0DCE4", imageUrl: "/prints/shame/shame_contraction.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "shame-crumple", title: "Crumple", series: "shame", equation: "κ(s) → ∞ at fold lines", description: "A smooth surface developing infinite curvature at fold lines — the geometry of crumpling paper.", emotionalNote: "Smoothness collapsing into sharp, irreversible folds", background: "#E0DCE4", imageUrl: "/prints/shame/shame_crumple.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "shame-fold", title: "Fold", series: "shame", equation: "f(x) = f(−x), x → 0", description: "A function folding onto itself — the two halves meeting and collapsing the space between them.", emotionalNote: "Folding inward until the outside is hidden", background: "#E0DCE4", imageUrl: "/prints/shame/shame_fold.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "shame-shrink", title: "Shrink", series: "shame", equation: "A(t) = A₀ · e^{-λt}", description: "An envelope that decays exponentially — the amplitude shrinking until the signal becomes invisible.", emotionalNote: "Making yourself smaller until you disappear", background: "#E0DCE4", imageUrl: "/prints/shame/shame_shrink.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "shame-veil", title: "Veil", series: "shame", equation: "f(x) = f(x) · (1 - g(x))", description: "A function multiplied by its own complement — the signal masking itself, hiding behind its own structure.", emotionalNote: "Hiding behind the structure of what you are", background: "#E0DCE4", imageUrl: "/prints/shame/shame_veil.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── NOSTALGIA ───────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "nostalgia-reaching", title: "Reaching", series: "nostalgia", equation: "y(t) → ∞, ∂y/∂t → 0", description: "A bold stem rising from an amber origin — thinning as it climbs toward the future, with tendrils arcing off and sweeping back toward where it began. Moving forward but always reaching back.", emotionalNote: "Moving forward but always reaching back", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_reaching.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "nostalgia-heirloom", title: "Heirloom", series: "nostalgia", equation: "Sₙ = (1+εₙ)·λ·Sₙ₋₁", description: "The same shape passed down through generations — each copy slightly larger, slightly less precise, slightly more distorted. The innermost form is still sharp; the outermost is barely a suggestion.", emotionalNote: "The same shape passed down, each copy less precise", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_heirloom.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "nostalgia-saudade", title: "Saudade", series: "nostalgia", equation: "r(θ) = r₀ + εθ + a·sin(3θ)", description: "Spirals that keep trying to close but drift — the Portuguese word for longing without an object. Each orbit almost returns but never quite reaches where it started.", emotionalNote: "Spirals that keep trying to close but drift", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_saudade.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "nostalgia-sepia", title: "Sepia", series: "nostalgia", equation: "Σ αₖ·G(x,y;μₖ,σₖ)", description: "Warm tones bleeding together like an aged photograph — overlapping Gaussian washes in amber, ochre, and sienna dissolving into each other. The soft focus of a memory you've recalled too many times.", emotionalNote: "Warm tones bleeding together like an old photograph", background: "#F0E8D8", imageUrl: "/prints/nostalgia/nostalgia_sepia.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── MELANCHOLY ──────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "melancholy-dissolve", title: "Dissolve", series: "melancholy", equation: "c(t) = c₀ · e^{-kt}", description: "Concentration decaying in solution — the sharp definition of a substance spreading into homogeneous nothing.", emotionalNote: "Definition spreading until it becomes everything and nothing", background: "#D8D4D0", imageUrl: "/prints/melancholy/melancholy_dissolve.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "melancholy-drift", title: "Drift", series: "melancholy", equation: "dx = μdt + σdW", description: "Brownian motion with weak drift — a slow, purposeless migration. Direction exists but barely matters.", emotionalNote: "Movement without purpose, direction without urgency", background: "#D8D4D0", imageUrl: "/prints/melancholy/melancholy_drift.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "melancholy-elegy", title: "Elegy", series: "melancholy", equation: "f(t) = A · t^{-α}, α ∈ (0,1)", description: "Power-law decay — slower than exponential, the signal fades but refuses to vanish. A long, slow diminuendo.", emotionalNote: "Fading slower than grief, refusing to fully vanish", background: "#D8D4D0", imageUrl: "/prints/melancholy/melancholy_elegy.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "melancholy-entropy", title: "Entropy", series: "melancholy", equation: "S = -k Σ pᵢ ln pᵢ, dS/dt ≥ 0", description: "Shannon entropy increasing — the system slowly losing the information that once made it ordered.", emotionalNote: "Order slowly becoming indistinguishable from noise", background: "#D8D4D0", imageUrl: "/prints/melancholy/melancholy_entropy.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "melancholy-lethe", title: "Lethe", series: "melancholy", equation: "∂c/∂t + v·∇c = D∇²c", description: "Advection-diffusion in a slow river — the substance carried downstream and dispersed. Named for the river of forgetting.", emotionalNote: "The slow current that carries memory away", background: "#D8D4D0", imageUrl: "/prints/melancholy/melancholy_lethe.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── WONDER ──────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "wonder-apollonian-gasket", title: "Apollonian Gasket", series: "wonder", equation: "(k₁+k₂+k₃+k₄)² = 2(k₁²+k₂²+k₃²+k₄²)", description: "Descartes' Circle Theorem iterated — circles packed inside circles, the gaps filled to infinity.", emotionalNote: "Infinity nested inside a finite space", background: "#0A0A18", imageUrl: "/prints/wonder/wonder_apollonian_gasket.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "wonder-harmonograph", title: "Harmonograph", series: "wonder", equation: "x = A₁sin(f₁t+φ₁)e^{-d₁t} + A₂sin(f₂t+φ₂)e^{-d₂t}", description: "Two damped pendulums coupled by a drawing surface — the pattern emerges from the interaction of decay rates.", emotionalNote: "Beauty emerging from the interaction of simple motions", background: "#0A0A18", imageUrl: "/prints/wonder/wonder_harmonograph.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "wonder-mandelbrot-orbit", title: "Mandelbrot Orbit", series: "wonder", equation: "z_{n+1} = z_n² + c", description: "Individual orbits of the Mandelbrot iteration — not the set boundary, but the trajectories themselves.", emotionalNote: "The invisible paths that define the boundary of chaos", background: "#0A0A18", imageUrl: "/prints/wonder/wonder_mandelbrot_orbit.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "wonder-recursion", title: "Recursion", series: "wonder", equation: "f(n) = f(f(n-1))", description: "A function that calls itself — each level of depth revealing new structure, the whole containing copies of itself.", emotionalNote: "The whole containing copies of itself at every scale", background: "#0A0A18", imageUrl: "/prints/wonder/wonder_recursion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── AWE ─────────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "awe-singularity", title: "Singularity", series: "awe", equation: "r(φ) = a(1-e²)/(1+e·cosφ)", description: "A black hole accretion disk — matter spiraling inward, light bending around the event horizon, time dilating to infinity at the photon sphere.", emotionalNote: "Where gravity bends light and time loses meaning", background: "#0A0A10", imageUrl: "/prints/awe/awe_singularity.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
  ...
  // ── RAGE ────────────────────────────────────────────────
  {
    ...
    makingOf: "42 renders. 5 survived.",
    pieces: [
      { id: "rage-chaos", title: "Chaos", series: "rage", equation: "x_{n+1} = 4x_n(1-x_n)", description: "The logistic map at r=4 — fully chaotic. Every initial condition leads to a completely unpredictable trajectory.", emotionalNote: "Every path leads to complete unpredictability", background: "#1A0A0A", imageUrl: "/prints/rage/rage_chaos.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "rage-detonation", title: "Detonation", series: "rage", equation: "D = √(2(γ²-1)q)", description: "The Chapman-Jouguet detonation velocity — the minimum speed at which a detonation wave can propagate.", emotionalNote: "The minimum speed of total destruction", background: "#1A0A0A", imageUrl: "/prints/rage/rage_detonation.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "rage-eruption", title: "Eruption", series: "rage", equation: "p(z) = ρgz + p₀, p > p_yield", description: "Pressure exceeding yield strength — the magma chamber equation. Containment fails. Everything comes up.", emotionalNote: "Pressure that has exceeded every possible containment", background: "#1A0A0A", imageUrl: "/prints/rage/rage_eruption.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "rage-shatter", title: "Shatter", series: "rage", equation: "E_release > Σ G_c · A_crack", description: "Griffith fracture — when the energy available exceeds the surface energy of all possible cracks simultaneously.", emotionalNote: "Energy exceeding every crack surface at once", background: "#1A0A0A", imageUrl: "/prints/rage/rage_shatter.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "rage-shockwave", title: "Shockwave", series: "rage", equation: "v > c, M = v/c >> 1", description: "Motion faster than the medium can communicate — the Mach cone. The wave arrives before the warning.", emotionalNote: "The wave arriving before the warning", background: "#1A0A0A", imageUrl: "/prints/rage/rage_shockwave.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── JOY ─────────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "joy-confetti", title: "Confetti", series: "joy", equation: "P(x,y) ~ Uniform(Ω), N >> 1", description: "Uniform random scatter — every point equally likely, no clustering, no preference. Pure equiprobable celebration.", emotionalNote: "Every point equally likely, the mathematics of celebration", background: "#FFFCF0", imageUrl: "/prints/joy/joy_confetti.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "joy-lissajous", title: "Lissajous", series: "joy", equation: "x = sin(3t), y = sin(4t)", description: "A Lissajous figure at a 3:4 frequency ratio — the closed curve of two harmonics in perfect relationship.", emotionalNote: "Two harmonics dancing in perfect ratio", background: "#FFFCF0", imageUrl: "/prints/joy/joy_lissajous.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "joy-pinwheel", title: "Pinwheel", series: "joy", equation: "f(r,θ) = cos(nθ + αr)", description: "A spiral pinwheel — rotational symmetry with radial twist. The pattern spins without effort.", emotionalNote: "Spinning without friction, turning without effort", background: "#FFFCF0", imageUrl: "/prints/joy/joy_pinwheel.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "joy-sunburst", title: "Sunburst", series: "joy", equation: "I(r,θ) = I₀ · (1/r) · Σ δ(θ - 2πn/N)", description: "Radial intensity along N directions — light streaming outward from a center in equal measure.", emotionalNote: "Light streaming outward in every direction equally", background: "#FFFCF0", imageUrl: "/prints/joy/joy_sunburst.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── EUPHORIA ────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "euphoria-firework", title: "Firework", series: "euphoria", equation: "r(t) = v₀t - ½gt², θ ~ Uniform(0,2π)", description: "Radial ballistic trajectories — launched from a single point, expanding in all directions, then falling.", emotionalNote: "Everything expanding from one brilliant moment", background: "#0A0A14", imageUrl: "/prints/euphoria/euphoria_firework.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "euphoria-kaleidoscope", title: "Kaleidoscope", series: "euphoria", equation: "f(r,θ) = f(r, θ + 2π/n), n = 6", description: "A function with n-fold rotational symmetry — every rotation reveals the same pattern. Perfect repeated beauty.", emotionalNote: "The same beauty repeated at every angle", background: "#0A0A14", imageUrl: "/prints/euphoria/euphoria_kaleidoscope.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "euphoria-prismatic", title: "Prismatic", series: "euphoria", equation: "n(λ) = A + B/λ² + C/λ⁴", description: "Cauchy's dispersion equation — white light separated into its spectrum. Every wavelength revealed.", emotionalNote: "White light separated into everything it contains", background: "#0A0A14", imageUrl: "/prints/euphoria/euphoria_prismatic.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "euphoria-stained-glass", title: "Stained Glass", series: "euphoria", equation: "T(λ,x,y) = Σ cᵢ · χ_{Ωᵢ}(x,y) · S(λ)", description: "Spectral transmission through colored regions — tessellated domains each filtering light differently.", emotionalNote: "Light passing through colored geometry", background: "#0A0A14", imageUrl: "/prints/euphoria/euphoria_stained_glass.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
