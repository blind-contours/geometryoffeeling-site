...
export const series: Series[] = [
  ...
  // ── GROWTH ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "growth-phyllotaxis", title: "Phyllotaxis", series: "growth", equation: "r = c√n, θ = n × 137.508°", description: "Two sunflowers — one full and heavy, one barely started — leaning toward each other on curved stems. Same rule driving both: each seed placed at the golden angle, spiraling outward. Nine hundred seeds packed tight in the parent bloom. A hundred and eighty in the young one, still finding its shape. I kept staring at the small one. Same mathematics, just earlier in the story.", emotionalNote: "Same rule, different scale — parent and child", background: "#F5F0E6", imageUrl: "/prints/growth/growth_phyllotaxis.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
