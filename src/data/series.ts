...
export const series: Series[] = [
  ...
  // ── GROWTH ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "growth-mycelium", title: "Mycelium", series: "growth", equation: "6×SC(attract, kill, step)", description: "Beneath the surface, something is quietly connecting everything. Six branching networks grow through a shared space, thick trunks tapering to gossamer threads — an architecture no one designed but everything depends on. Built from the space colonization algorithm, which models how fungal networks find and claim territory.", emotionalNote: "The hidden network that connects everything underground", background: "#F5F0E6", imageUrl: "/prints/growth/growth_mycelium.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "growth-meadow", title: "Meadow", series: "growth", equation: "y_n(t) = h_n·t, h_n ∼ Beta(3, 1.5)", description: "A field where everything grows at its own pace. Most stems tall, a few still rising, none in a hurry. The unevenness is what makes it real — a meadow is beautiful precisely because nothing in it is synchronized.", emotionalNote: "A field where everything grows at its own pace", background: "#F5F0E6", imageUrl: "/prints/growth/growth_meadow.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "growth-bifurcation", title: "Bifurcation", series: "growth", equation: "x_{n+1} = rx_n(1 - x_n), r ∈ [2.5, 4]", description: "A single strategy that works — until it doesn't. Then it splits, and splits again, until what started simple becomes irreducibly complex. Growth isn't always upward. Sometimes it's outward, into possibility. Built from the logistic bifurcation diagram, where simplicity branches into chaos.", emotionalNote: "Simple beginnings branching until they can't be simplified", background: "#F5F0E6", imageUrl: "/prints/growth/growth_bifurcation.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── DESIRE ──────────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "desire-pursuit", title: "Pursuit", series: "desire", equation: "dx/dt=αx−βxy, dy/dt=δxy−γy", description: "I tried to make them meet. They won't — they circle each other endlessly, always closing the distance, never arriving. The system doesn't allow it. The approach is the point, not the arrival. That ache of almost-touching is where desire actually lives.", emotionalNote: "Endless approach, never arrival", background: "#2A2018", imageUrl: "/prints/desire/desire_pursuit.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "desire-magnetism", title: "Magnetism", series: "desire", equation: "B=μ₀/(4π)·(3(m·r̂)r̂−m)/r³", description: "The pull you can feel but can't see. Invisible force arcing between two bodies, shaping the space around them, bending every nearby path. You know it's there because everything curves. I wanted to render that — the thing that isn't visible but reshapes everything around it.", emotionalNote: "The pull you can feel but can't see", background: "#2A2018", imageUrl: "/prints/desire/desire_magnetism.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "desire-pulse", title: "Pulse", series: "desire", equation: "f(t)=A·exp(−(t mod T)/σ)", description: "A heartbeat that won't slow down. Peaked waveforms accelerating — spacing tightening, amplitude rising, each beat arriving sooner and harder than the last. The rhythm of wanting something more with every passing moment.", emotionalNote: "A heartbeat that won't slow down", background: "#2A2018", imageUrl: "/prints/desire/desire_pulse.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "desire-inspiral", title: "Inspiral", series: "desire", equation: "r(θ)=r₀·e^(−γθ)", description: "Accelerating toward something you can't stop. Concentric spirals tightening toward a glowing center, each orbit faster and closer than the last. I kept watching the curves accelerate inward and thought — that's what it feels like. The closer you get, the less choice you have.", emotionalNote: "Accelerating toward something you can't stop", background: "#2A2018", imageUrl: "/prints/desire/desire_inspiral.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
  ...
  // ── AWE ─────────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "awe-eclipse", title: "Eclipse", series: "awe", equation: "I(r) = I_corona / r", description: "What the sun reveals only when it's hidden. Streamers of plasma radiating outward during totality, a diamond ring at the limb — the corona visible for a few minutes of darkness. Built from an inverse-distance field, the math the sun actually follows.", emotionalNote: "What the sun reveals only when it's hidden", background: "#0A0A10", imageUrl: "/prints/awe/awe_eclipse.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
