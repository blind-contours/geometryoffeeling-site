...
export const series: Series[] = [
  ...
  // ── CONNECTION ──────────────────────────────────────────
  {
    ...
    pieces: [
      { id: "connection-coupled-oscillators", title: "Coupled Oscillators", series: "connection", equation: "x″ = −ω²x + κ(x₂−x₁)", description: "Two oscillators linked by a spring constant. Their phase-space trajectories spiral around each other — close but never merging. The coupling reshapes both orbits.", emotionalNote: "Two rhythms reshaping each other", background: "#E8D8B8", imageUrl: "/prints/connection/connection_coupled_oscillators.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-pendulum", title: "Pendulum", series: "connection", equation: "θ̈ = -(g/L)sinθ + k(θ₂ - θ₁)", description: "Two coupled pendulums trading energy back and forth in phase space. I tuned the coupling constant until their trajectories spiraled around each other without ever merging.", emotionalNote: "Energy passing between two systems that never merge", background: "#E8D8B8", imageUrl: "/prints/connection/connection_pendulum.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      ...
      { id: "connection-magnetic", title: "Magnetic", series: "connection", equation: "B = B₁ + B₂, ∇×B = μ₀J", description: "I superimposed the fields of two magnetic dipoles and drew the lines arcing between them. The pull is invisible, but it shapes everything around it.", emotionalNote: "The invisible force that shapes the space between", background: "#E8D8B8", imageUrl: "/prints/connection/connection_magnetic.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-lissajous", title: "Lissajous", series: "connection", equation: "x = sin(3t), y = sin(2t + φ)", description: "A 3:2 Lissajous figure with a phase offset. Two frequencies tracing a single curve — the same motion, half a beat apart.", emotionalNote: "The same motion, half a beat apart", background: "#E8D8B8", imageUrl: "/prints/connection/connection_lissajous.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-entanglement", title: "Entanglement", series: "connection", equation: "|ψ⟩ = (|01⟩ - |10⟩)/√2", description: "Two signals separated in space but perfectly correlated. I added visible lines to trace what quantum mechanics says is there but can't be seen.", emotionalNote: "Connected across any distance", background: "#E8D8B8", imageUrl: "/prints/connection/connection_entanglement.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-torus-knot", title: "Torus Knot", series: "connection", equation: "x = (R+r·cos(qt))cos(pt)", description: "A curve wound around a torus at two frequencies, locked in a knot that can never be untied without cutting. Once it's tied, that's it.", emotionalNote: "Two frequencies locked together permanently", background: "#E8D8B8", imageUrl: "/prints/connection/connection_torus_knot.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-weave", title: "Weave", series: "connection", equation: "y₁ = sin(ωt), y₂ = sin(ωt + π/2)", description: "Pairs of sine waves crossing at every frequency — tight braids at the top, slow sweeping crossings at the bottom. I wanted to show interleaving at every scale.", emotionalNote: "Interleaving at every scale", background: "#E8D8B8", imageUrl: "/prints/connection/connection_weave.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
      { id: "connection-helix", title: "Helix", series: "connection", equation: "x = r·cos(t), y = r·sin(t), z = ct", description: "A double helix — two strands spiraling in parallel, always the same distance apart. They never touch. That constant distance is the whole point.", emotionalNote: "Always the same distance apart, never touching", background: "#E8D8B8", imageUrl: "/prints/connection/connection_helix.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
