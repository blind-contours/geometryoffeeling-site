...
export const series: Series[] = [
  ...
  // ── WONDER ──────────────────────────────────────────────
  {
    ...
    pieces: [
      ...
      { id: "wonder-inversion", title: "Inversion", series: "wonder", equation: "w = R²/z̄", description: "Ten days of silence. Somewhere around day seven, the boundary between body and mind stopped meaning anything. Not dissolved — inverted. What had been two separate experiences became one field, and in the narrow passage between them, something opened that I'd never felt before. This piece came from that. Parallel lines pass through a circle inversion and become arcs that converge on a single luminous point — the place where separation ends and a new dimension of experience begins.", emotionalNote: "What opens when body and mind stop being two things", background: "#DDD9D2", imageUrl: "/prints/wonder/wonder_inversion.jpg", gumroadUrl: "https://gumroad.com/l/placeholder", price: 45 },
    ],
